...
<body>
    ...
    <main class="about">
        <div class="about__column">
            ...
            <img src="/images/profPic.png" class="about__img about_img--left" alt="A rather cool guy in denim jacket standing in front of pink flowers.">
        </div>
        <div class="about__column">
            ...
            <img src="/images/profPic.png" class="about__img about_img--center" alt="">
        </div>
        <div class="about__column">
            <section class="about__section">
                <h2>FAQ</h2>
            ...
            <img src="/images/profPic.png" class="about__img about_img--right" alt="">
        </div>
    </main>
</body>
</html>