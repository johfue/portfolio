  ...
  return (
    <>
        ...
        <section class="work__section work__section--accent light">
            ...
            <span></span>
            <Media type="video" class="right" src="/media/chooseDigital.mp4" autoplay="true" alt=""/>
            <Media type="image" class="right" src="/images/chooseDigital.jpg" alt="Chinese BBQ, Frozen custard, Line dancing."/>
        </section>
