...
switch ($_SERVER["SCRIPT_NAME"]) {
		...
		case "/work/rei.php":
			...
			$CONTENT = '
                    <h2>Print Campaign</h2>
                        ...
                        <b></b>
                        <img src="/images/reiHose.jpg" class="center tall" alt="A print magazine ad. A man is climbing a cliff. However, one of his ropes is actually a gardening hose. The copy reads &quot;Too guilty to get new gear? An option nature and your waller will agree on. At REI you can rent everything you need for you next trip - no need to improvise. Or you can buy second-hand from our members only garage sale. Either way, less junk in our landfills and more green in your wallet.&quot;">
                    <h2 class="wide">Out-of-home</h2>
                        <img src="/images/reiBroom.jpg" class="center wide" alt="A print billboard ad. A woman is canoing out on a lake. Instead of a paddle, she has a broom. The copy reads &quot;You shouldn\'t always recycle. Shop certified second-hand gear.&quot;">
                        <img src="/images/reiPlunge.jpg" class="center wide" alt="A print billboard ad. A man is struggling to climb an icy cliff. Instead of a pickaxe, he has a toliet plunger. The copy reads &quot;You shouldn\'t always recycle. Gear up with rental equipment&quot;">';
			break;
        case "/work/proof.php":
            $CURRENT_PAGE = "PROOF";
			$PAGE_TITLE = "PROOF";
			...
			$CONTENT = '
                    <h2>Print Campaign</h2>
                        <img src="/images/proofBerry.jpg" class="center tall" alt="A print magazine ad. The headline reads &quot;We won\'t judge what happens after the last the bite.&quot;">
                        <b></b>
                        <img src="/images/proofSpoon.jpg" class="center tall" alt="A print magazine ad. The headline reads &quot;Your secrets are safe with the spoon.&quot;">
                        <b></b>
                        <img src="/images/proofShaker.jpg" class="center tall" alt="A print magazine ad. The headline reads &quot;But what if you could have it all?&quot;">
		...
		case "/work/palmetto.php":
			...
			$CONTENT = '
                        <h2>Logo Design</h2>
                        <img src="/images/padExplain.png" class="wide center" alt="A logo. It is of an airple with it\'s rotors stylizied to look like palm leaves. The company\'s name sits underneath. A diagram depicts the grid in which the logo is constructed. Beneath is a diagram showing the insipration for the logo. It combines a palmtree and airplane">';
			break;
		case "/work/personal.php":
			...
			$CONTENT = '
                        <figure class="wide">
                            ...
                            <figcaption>Pencil on paper<button onclick="modalExpand(this)">SVG</button></figcaption>
                        </figure>
                        <figure class="wide">
